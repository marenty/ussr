...
class ClParams(models.Model):
    max_debt = models.TextField()  # This field type is a guess.
...
class ClPayment(models.Model):
    ...
    payment_sum = models.TextField(blank=True, null=True)  # This field type is a guess.
    paid_amount = models.TextField(blank=True, null=True)  # This field type is a guess.
...
class ClPaymentLine(models.Model):
    ...
    final_price = models.TextField(blank=True, null=True)  # This field type is a guess.
    currency = models.ForeignKey('Currrency', models.DO_NOTHING, db_column='currency')
    company_branch = models.ForeignKey('CompanyBranch', models.DO_NOTHING, db_column='company_branch')
...
class ResourcesUsage(models.Model):
    ...
    time_slot = models.ForeignKey('TimeSlotList', models.DO_NOTHING, db_column='time_slot')
    calendar_date = models.ForeignKey('WorkdayCalendar', models.DO_NOTHING, db_column='calendar_date')
    company_branch = models.ForeignKey(CompanyBranch, models.DO_NOTHING, db_column='company_branch')
...
class SeDict(models.Model):
    ...
    base_price = models.TextField(blank=True, null=True)  # This field type is a guess.
...
class SeDiscount(models.Model):
    id_se_discount = models.AutoField()
    discount = models.ForeignKey(DiscountDict, models.DO_NOTHING, db_column='discount')
    service = models.ForeignKey('Service', models.DO_NOTHING, db_column='service')
    company_branch = models.CharField(max_length=10)
