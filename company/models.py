...
class CompanyBranch(models.Model):
    ...
    is_main = models.NullBooleanField(verbose_name='Główny')
    ...
    longitude = models.DecimalField(max_digits=9, decimal_places=6, blank=True, null=True, verbose_name='Długość geograficzna')
    latitude = models.DecimalField(max_digits=9, decimal_places=6, blank=True, null=True, verbose_name='Szerokość geograficzna')
